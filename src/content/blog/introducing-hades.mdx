---
title: "Introducing Hades"
description: "A closer look at the structure, content system, and design choices behind the Hades portfolio theme."
pubDate: 2026-05-18
author: hades
tags: ["release", "astro", "architecture"]
---

# A Practical Portfolio Theme

Building a personal portfolio is hard enough. A good starter should give you a useful structure, sensible defaults, and room to adapt the details to your style.

Hades is designed as a focused foundation for portfolio websites: hero, features, skills, contact, and common UI patterns are all included.

<Callout type="info" title="The Hades Philosophy">
...
Hades keeps the implementation close to Astro's strengths: static output, content collections, MDX support, and small amounts of client-side JavaScript where interaction is needed.
...
<Callout type="success" title="Zero Configuration">
  View transitions are enabled by default in Hades. You don't need to write a single line of JavaScript to get SPA-like routing.
</Callout>
...
@layer utilities {
  .glass-panel {
    @apply bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl border border-gray-200/50 dark:border-gray-800/50 shadow-xl;
  }
}
```
...
Hades is meant to be a starting point. Use the structure, adjust the copy, and shape the visual details around your own portfolio.
